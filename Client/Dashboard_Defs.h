...
#ifdef __cplusplus
		XUIElementPropVal() {
			((void(*)(...))(Utilities::Resolve((HMODULE)DashboardHandle, 10079)))(this);
		}
		~XUIElementPropVal() {
			((void(*)(...))(Utilities::Resolve((HMODULE)DashboardHandle, 10080)))(this);
		}
#endif
	};
...
namespace Dashboard_Calls {
	...
	extern HRESULT SetFillLINEAR(HXUIOBJ hObj, DWORD Color1, DWORD Color2, BOOL Gradient);
	extern HRESULT SetFillRADIAL(HXUIOBJ hObj, DWORD Color3, DWORD Color4, BOOL Gradient);
	extern HRESULT RotatingSetFillDash(HXUIOBJ hObj, DWORD Color1, DWORD Color2, BOOL Gradient, BOOL RainbowMode);
